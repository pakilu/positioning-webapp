...
namespace WebApp.Controllers
{
    public class SessionConfigChipsController : Controller
    {
        ...
        // The former top-level Layout Chips list is retired.
        // Chip-in-room placements are now managed from the room detail
        // cockpit (Views/SessionConfigs/Details.cshtml). Redirect the old
        // route so external bookmarks still resolve.
        public IActionResult Index() => RedirectToAction("Index", "SessionConfigs");
